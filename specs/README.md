# marketing-spec-kit Specifications
...
│   ├── spec.md                 ← Domain specification/rules/standards
...
**Example**: `specs/001-generic-spec/spec.md`
...
1. ✅ **Clear Concerns**: Specification experts define Feature 1, toolkit experts define Feature 2
...
```bash
/sdx.specify "Define generic specification"
# Creates specs/001-generic-spec/spec.md
...
```bash
/sdx.specify "Define toolkit for generic specification"
...
**Status**: 🟢 Ready for development | **Last Updated**: 2025-11-14
